...
$TCA['tx_vmfdssermons_domain_model_series'] = [
    'ctrl' => [
        ...
        'searchFields' => 'title,subtitle,startdate,enddate,description,image,image_preview,image_source',
    ],
    'interface' => [
        'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, title, subtitle, startdate, enddate, description, image,image_preview,image_source, hashtags',
    ],
    'types' => [
        '1' => ['showitem' => 'sys_language_uid;;;;1-1-1, l10n_parent, l10n_diffsource, hidden;;1, title, subtitle, startdate, enddate, description, image,image_preview,image_source, hashtags,--div--;LLL:EXT:cms/locallang_ttc.xlf:tabs.access,starttime, endtime'],
    ],
    'palettes' => [
        '1' => ['showitem' => ''],
    ],
    'columns' => [
        ...
        'image_preview' => [
            'exclude' => 0,
            'label' => 'LLL:EXT:vmfds_sermons/Resources/Private/Language/locallang_db.xlf:tx_vmfdssermons_domain_model_series.image_preview',
            'config' => [
                'type' => 'group',
                'internal_type' => 'file',
                'uploadfolder' => 'predigten/Titelbilder',
        ...
        'image_source' => [
            'exclude' => 0,
            'label' => 'LLL:EXT:vmfds_sermons/Resources/Private/Language/locallang_db.xlf:tx_vmfdssermons_domain_model_series.image_source',
            'config' => [
                'type' => 'input',
                'size' => 30,
                'eval' => 'trim'
...
return $TCA['tx_vmfdssermons_domain_model_series'];